...
function App() {
    ...
    const actionButton = {
        ...
        loadingStyleModel: {action: loadStyleModel, text: "Loading Style Model..."},
        ...
        identifying: {action: identify, text: "Computing transformer..."},
    ...
    return (
        <Grid container spacing={0} direction={"column"} justify="center" alignItems="center">
            ...
            {showResults && <Canvas/>}
            <Button variant="contained" onClick={actionButton[appState].action || (() => {
            })}>
